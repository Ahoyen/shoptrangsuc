...
-->
	<div class="row">
		<div id="sidebar" class="span3">
			...
			<div class="well well-small">
				<a href="#"><img
					src="<c:url value="/template/web/assets/img/paypal.jpg"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img
							src="<c:url value="/template/web/assets/img/bootstrap-ecommerce-templates.png"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
							src="<c:url value="/template/web/assets/img/shopping-cart-template.png"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
							src="<c:url value="/template/web/assets/img/bootstrap-template.png"/>"
				...
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<c:forEach var="item" items="${slides}" varStatus="index">
							...
							<img style="width: 100%"
								src="<c:url value="/template/web/assets/img/slides/${item.img}"/>"
								alt="bootstrap ecommerce templates">
